...
function Card({ id, imgPreview, brand, typeClothes, price, onPlus, onFavorite }) {
  ...
  const handleOnFavorite = () => {
    ...
    onFavorite({ id, imgPreview, brand, typeClothes, price })
  }

  /** Отслеживаем нажатие на кнопку plus, и передаем данные карточки */
  const handleOnPlus = () => {
    onPlus({ id, imgPreview, brand, typeClothes, price });
  }
